...
const skillCategories = [
  {
    ...
    skills: [
      { name: "Next.js", icon: <Code2 size={18} />, level: 80 },
      { name: "React Native", icon: <Smartphone size={18} />, level: 75 },
      { name: "Django", icon: <Database size={18} />, level: 60 },
      { name: "TypeScript", icon: <Code2 size={18} />, level: 70 },
      { name: "PostgreSQL", icon: <Database size={18} />, level: 50 },
      { name: "REST API", icon: <Globe size={18} />, level: 60 },
    ],
  },
  {
    ...
    skills: [
      { name: "Deep Learning from Scratch", icon: <Brain size={18} />, level: 60 },
      { name: "Python", icon: <Terminal size={18} />, level: 80 },
      { name: "Neural Networks", icon: <Cpu size={18} />, level: 70 },
      { name: "Machine Learning", icon: <Brain size={18} />, level: 65 },
      { name: "NumPy & Algorithmes", icon: <Code2 size={18} />, level: 75 },
  ...
  },
  {
    ...
    skills: [
      { name: "Pentesting", icon: <Terminal size={18} />, level: 65 },
      { name: "OWASP Top 10", icon: <Shield size={18} />, level: 70 },
      { name: "Cryptographie", icon: <Lock size={18} />, level: 80 },
      { name: "Kali Linux", icon: <Terminal size={18} />, level: 80 },
      { name: "Burp Suite", icon: <Shield size={18} />, level: 75 },
      { name: "Metasploit", icon: <Terminal size={18} />, level: 60 },
    ],
  },
];
